...
public class TP02Q13 {
	...
	public static void main(String[] args) {
        ...
        MergeSort(JogadorSelecionado, Jogador.CompUniversidade);
        ...
        try{
            FileWriter fileWriter = new FileWriter("matricula_mergesort.txt");
    ...
    public static void MergeSort(ArrayList<Jogador> array, Comparator<Jogador> comparator){
		if(array.size() > 1){
            comparacao++;
            ...
            MergeSort(Esquerda, comparator);
            movimentacoes++;
            MergeSort(Direita, comparator);
            movimentacoes++;
            int i = 0, j = 0, k = 0;
